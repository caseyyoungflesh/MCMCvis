...
#' prior manipulation. Summary information, posterior chains, and posterior disritbution plots can be easily
#' obtained for any parameter of interest within each function. Each function is designed to operate independently
#' of one another.
#'
#' @section Author(s):
