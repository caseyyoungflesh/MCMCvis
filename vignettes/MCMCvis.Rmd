...
nimble_out <- nimbleMCMC(code = mf2, 
                         constants = list(N = 10), 
                         data = data, 
                         inits = list(mu = 0),
                         nchains = 4,
...
The `excl` argument can be used to exclude any parameters. For instance, if all parameters are desired **except** for the `alphas`, `params = 'all', excl = 'alpha', ISB = FALSE, exact = FALSE` can be used. These arguments can be used in any of the functions in the package.
...
MCMCdiag(model_fit, 
         ...
         add_obj_names = c('model-data-YYYY-MM-DD', 
                           'session-info-YYYY-MM-DD'),
