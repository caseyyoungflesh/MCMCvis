...
A vertical guideline at 0 is plotted by default, but can be removed with `g_line = NULL`. Multiple guidelines can be plotted by concatenating argument input.
